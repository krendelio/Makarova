...
class Report:
    ...
    def image_generate(self, data, prof):
        ...
        self.image(count_vac_by_year, count_vac_by_year_for_prof, prof, salary_lvl_by_city, salary_lvl_by_year,
                   salary_lvl_by_year_for_prof, width_12, x_list1_1, x_list1_2, x_nums_1)
    ...
    def image(self, count_vac_by_year, count_vac_by_year_for_prof, prof, salary_lvl_by_city, salary_lvl_by_year,
              salary_lvl_by_year_for_prof, width_12, x_list1_1, x_list1_2, x_nums_1):
        ...
        list_names = self.image_conditions(salary_lvl_by_city)
        width_3 = 0.7
    ...
    def image_conditions(self, salary_lvl_by_city):
        list_names = {}
...
final = Report()
final.image_generate(data_output, input.profession_name)
